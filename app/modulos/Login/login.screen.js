...
import {setRol} from './../Shop/shop.utils';
...
export default class Login extends Component {
  ...
  consultarRol = async (uid) => {
    let data = await this.db.collection('tbl_usuario_rol').doc(uid).get();
    let rol = data ? data.data() : {id_rol: null};
    setRol(rol.id_rol);
  };
